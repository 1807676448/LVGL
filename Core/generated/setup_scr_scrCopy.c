...
void setup_scr_scrCopy(lv_ui *ui)
{
    ...
    lv_obj_set_size(ui->scrCopy_contBG, 480, 58);
    ...
    lv_obj_set_pos(ui->scrCopy_labelTitle, 120, 11);
    lv_obj_set_size(ui->scrCopy_labelTitle, 232, 32);
    ...
    lv_obj_set_style_text_font(ui->scrCopy_labelTitle, &lv_font_montserratMedium_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->scrCopy_labelTitle, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->scrCopy_labelTitle, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->scrCopy_btnBack = lv_button_create(ui->scrCopy);
    lv_obj_set_pos(ui->scrCopy_btnBack, 20, 0);
    lv_obj_set_size(ui->scrCopy_btnBack, 51, 44);
    ui->scrCopy_btnBack_label = lv_label_create(ui->scrCopy_btnBack);
    lv_label_set_text(ui->scrCopy_btnBack_label, "" LV_SYMBOL_LEFT " ");
    ...
    lv_obj_set_pos(ui->scrCopy_contPanel, 355, 50);
    lv_obj_set_size(ui->scrCopy_contPanel, 105, 164);
    ...
    lv_obj_set_style_radius(ui->scrCopy_contPanel, 9, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->scrCopy_imgBright = lv_image_create(ui->scrCopy_contPanel);
    lv_obj_set_pos(ui->scrCopy_imgBright, 18, 9);
    lv_obj_set_size(ui->scrCopy_imgBright, 20, 20);
    lv_obj_add_flag(ui->scrCopy_imgBright, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->scrCopy_imgBright, &_bright_RGB565A8_20x20);
    lv_image_set_pivot(ui->scrCopy_imgBright, 50,50);
    lv_image_set_rotation(ui->scrCopy_imgBright, 0);

    //Write style for scrCopy_imgBright, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_image_recolor_opa(ui->scrCopy_imgBright, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_image_opa(ui->scrCopy_imgBright, 255, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes scrCopy_imgColor
    ui->scrCopy_imgColor = lv_image_create(ui->scrCopy_contPanel);
    lv_obj_set_pos(ui->scrCopy_imgColor, 61, 9);
    lv_obj_set_size(ui->scrCopy_imgColor, 18, 18);
    lv_obj_add_flag(ui->scrCopy_imgColor, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->scrCopy_imgColor, &_hue_RGB565A8_18x18);
    lv_image_set_pivot(ui->scrCopy_imgColor, 50,50);
    lv_image_set_rotation(ui->scrCopy_imgColor, 0);

    //Write style for scrCopy_imgColor, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_image_recolor_opa(ui->scrCopy_imgColor, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_image_opa(ui->scrCopy_imgColor, 255, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes scrCopy_sliderBright
    ui->scrCopy_sliderBright = lv_slider_create(ui->scrCopy_contPanel);
    lv_obj_set_pos(ui->scrCopy_sliderBright, 25, 41);
    lv_obj_set_size(ui->scrCopy_sliderBright, 5, 111);
    ...
    lv_obj_set_style_radius(ui->scrCopy_sliderBright, 58, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_radius(ui->scrCopy_sliderBright, 58, LV_PART_INDICATOR|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_radius(ui->scrCopy_sliderBright, 58, LV_PART_KNOB|LV_STATE_DEFAULT);

    //Write codes scrCopy_sliderHue
    ui->scrCopy_sliderHue = lv_slider_create(ui->scrCopy_contPanel);
    lv_obj_set_pos(ui->scrCopy_sliderHue, 68, 41);
    lv_obj_set_size(ui->scrCopy_sliderHue, 5, 111);
    lv_slider_set_range(ui->scrCopy_sliderHue, 0, 100);
    lv_slider_set_mode(ui->scrCopy_sliderHue, LV_SLIDER_MODE_NORMAL);
    lv_slider_set_value(ui->scrCopy_sliderHue, 50, LV_ANIM_OFF);
    ...
    lv_obj_set_style_radius(ui->scrCopy_sliderHue, 58, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_radius(ui->scrCopy_sliderHue, 58, LV_PART_INDICATOR|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_radius(ui->scrCopy_sliderHue, 58, LV_PART_KNOB|LV_STATE_DEFAULT);

    //Write codes scrCopy_btnNext
    ui->scrCopy_btnNext = lv_button_create(ui->scrCopy);
    lv_obj_set_pos(ui->scrCopy_btnNext, 360, 235);
    lv_obj_set_size(ui->scrCopy_btnNext, 100, 41);
    ...
    lv_obj_set_style_radius(ui->scrCopy_btnNext, 23, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->scrCopy_btnNext, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    //Write codes scrCopy_contImage
    ui->scrCopy_contImage = lv_obj_create(ui->scrCopy);
    lv_obj_set_pos(ui->scrCopy_contImage, 20, 50);
    lv_obj_set_size(ui->scrCopy_contImage, 310, 228);
    lv_obj_set_scrollbar_mode(ui->scrCopy_contImage, LV_SCROLLBAR_MODE_OFF);

    //Write style for scrCopy_contImage, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->scrCopy_contImage, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->scrCopy_contImage, 9, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->scrCopy_contImage, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->scrCopy_contImage, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->scrCopy_contImage, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->scrCopy_contImage, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->scrCopy_contImage, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->scrCopy_contImage, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes scrCopy_imgScanned
    ui->scrCopy_imgScanned = lv_image_create(ui->scrCopy_contImage);
    lv_obj_set_pos(ui->scrCopy_imgScanned, 0, 0);
    lv_obj_set_size(ui->scrCopy_imgScanned, 310, 228);
    lv_obj_add_flag(ui->scrCopy_imgScanned, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->scrCopy_imgScanned, &_example_RGB565A8_310x228);
    lv_image_set_pivot(ui->scrCopy_imgScanned, 50,50);
    lv_image_set_rotation(ui->scrCopy_imgScanned, 0);

    //Write style for scrCopy_imgScanned, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_image_recolor_opa(ui->scrCopy_imgScanned, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_image_opa(ui->scrCopy_imgScanned, 255, LV_PART_MAIN|LV_STATE_DEFAULT);

    //The custom code of scrCopy.
    lv_obj_set_style_clip_corner(ui->scrCopy_contImage, true, 0);

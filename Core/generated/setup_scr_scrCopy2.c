...
void setup_scr_scrCopy2(lv_ui *ui)
{
    ...
    lv_obj_set_size(ui->scrCopy2_contBG, 480, 58);
    ...
    lv_obj_set_pos(ui->scrCopy2_labelTitle, 120, 11);
    lv_obj_set_size(ui->scrCopy2_labelTitle, 232, 32);
    ...
    lv_obj_set_style_text_font(ui->scrCopy2_labelTitle, &lv_font_montserratMedium_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->scrCopy2_labelTitle, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->scrCopy2_labelTitle, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->scrCopy2_btnBack = lv_button_create(ui->scrCopy2);
    lv_obj_set_pos(ui->scrCopy2_btnBack, 20, 0);
    lv_obj_set_size(ui->scrCopy2_btnBack, 51, 44);
    ui->scrCopy2_btnBack_label = lv_label_create(ui->scrCopy2_btnBack);
    lv_label_set_text(ui->scrCopy2_btnBack_label, "" LV_SYMBOL_LEFT " ");
    ...
    //Write codes scrCopy2_contImage
    ui->scrCopy2_contImage = lv_obj_create(ui->scrCopy2);
    lv_obj_set_pos(ui->scrCopy2_contImage, 20, 62);
    lv_obj_set_size(ui->scrCopy2_contImage, 310, 228);
    lv_obj_set_scrollbar_mode(ui->scrCopy2_contImage, LV_SCROLLBAR_MODE_OFF);

    //Write style for scrCopy2_contImage, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->scrCopy2_contImage, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->scrCopy2_contImage, 9, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->scrCopy2_contImage, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->scrCopy2_contImage, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->scrCopy2_contImage, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->scrCopy2_contImage, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->scrCopy2_contImage, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->scrCopy2_contImage, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes scrCopy2_imgScanned
    ui->scrCopy2_imgScanned = lv_image_create(ui->scrCopy2_contImage);
    lv_obj_set_pos(ui->scrCopy2_imgScanned, 0, 0);
    lv_obj_set_size(ui->scrCopy2_imgScanned, 310, 228);
    lv_obj_add_flag(ui->scrCopy2_imgScanned, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->scrCopy2_imgScanned, &_example_RGB565A8_310x228);
    lv_image_set_pivot(ui->scrCopy2_imgScanned, 0,0);
    lv_image_set_rotation(ui->scrCopy2_imgScanned, 0);

    //Write style for scrCopy2_imgScanned, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_image_recolor_opa(ui->scrCopy2_imgScanned, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_image_opa(ui->scrCopy2_imgScanned, 255, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes scrCopy2_contPanel
    ui->scrCopy2_contPanel = lv_obj_create(ui->scrCopy2);
    lv_obj_set_pos(ui->scrCopy2_contPanel, 280, 49);
    lv_obj_set_size(ui->scrCopy2_contPanel, 180, 167);
    ...
    lv_obj_set_style_radius(ui->scrCopy2_contPanel, 9, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->scrCopy2_labelCopies, 38, 9);
    lv_obj_set_size(ui->scrCopy2_labelCopies, 100, 32);
    ...
    lv_obj_set_style_text_font(ui->scrCopy2_labelCopies, &lv_font_montserratMedium_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->scrCopy2_btnMinus = lv_button_create(ui->scrCopy2_contPanel);
    lv_obj_set_pos(ui->scrCopy2_btnMinus, 14, 50);
    lv_obj_set_size(ui->scrCopy2_btnMinus, 35, 35);
    ...
    lv_obj_set_style_text_font(ui->scrCopy2_btnMinus, &lv_font_montserratMedium_25, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->scrCopy2_btnPlus = lv_button_create(ui->scrCopy2_contPanel);
    lv_obj_set_pos(ui->scrCopy2_btnPlus, 127, 50);
    lv_obj_set_size(ui->scrCopy2_btnPlus, 35, 35);
    ...
    lv_obj_set_style_text_font(ui->scrCopy2_btnPlus, &lv_font_montserratMedium_25, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->scrCopy2_labelCounter, 56, 50);
    lv_obj_set_size(ui->scrCopy2_labelCounter, 64, 35);
    ...
    lv_obj_set_style_text_font(ui->scrCopy2_labelCounter, &lv_font_montserratMedium_25, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->scrCopy2_labelColor, 10, 95);
    lv_obj_set_size(ui->scrCopy2_labelColor, 70, 30);
    ...
    lv_obj_set_style_text_font(ui->scrCopy2_labelColor, &lv_font_montserratMedium_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->scrCopy2_labelVertical, 90, 95);
    lv_obj_set_size(ui->scrCopy2_labelVertical, 88, 29);
    ...
    lv_obj_set_style_text_font(ui->scrCopy2_labelVertical, &lv_font_montserratMedium_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->scrCopy2_swColor, 24, 129);
    lv_obj_set_size(ui->scrCopy2_swColor, 44, 25);
    ...
    lv_obj_set_style_radius(ui->scrCopy2_swColor, 11, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_radius(ui->scrCopy2_swColor, 11, LV_PART_KNOB|LV_STATE_DEFAULT);

    //Write codes scrCopy2_swVertical
    ui->scrCopy2_swVertical = lv_switch_create(ui->scrCopy2_contPanel);
    lv_obj_set_pos(ui->scrCopy2_swVertical, 113, 129);
    lv_obj_set_size(ui->scrCopy2_swVertical, 44, 25);
    ...
    lv_obj_set_style_radius(ui->scrCopy2_swVertical, 11, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_radius(ui->scrCopy2_swVertical, 11, LV_PART_KNOB|LV_STATE_DEFAULT);

    //Write codes scrCopy2_btnNext
    ui->scrCopy2_btnNext = lv_button_create(ui->scrCopy2);
    lv_obj_set_pos(ui->scrCopy2_btnNext, 290, 247);
    lv_obj_set_size(ui->scrCopy2_btnNext, 160, 41);
    ...
    lv_obj_set_style_radius(ui->scrCopy2_btnNext, 23, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->scrCopy2_btnNext, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->scrCopy2_contDDLpanel, 20, 241);
    lv_obj_set_size(ui->scrCopy2_contDDLpanel, 235, 52);
    ...
    lv_obj_set_style_radius(ui->scrCopy2_contDDLpanel, 9, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->scrCopy2_ddlistMode, 10, 8);
    lv_obj_set_size(ui->scrCopy2_ddlistMode, 100, 35);
    ...
    lv_obj_set_style_text_font(ui->scrCopy2_ddlistMode, &lv_font_montserratMedium_14, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_style_set_text_color(&style_scrCopy2_ddlistMode_extra_list_main_default, lv_color_hex(0xffffff));
    lv_style_set_text_font(&style_scrCopy2_ddlistMode_extra_list_main_default, &lv_font_montserratMedium_14);
    ...
    lv_style_set_radius(&style_scrCopy2_ddlistMode_extra_list_main_default, 4);
    lv_style_set_bg_opa(&style_scrCopy2_ddlistMode_extra_list_main_default, 255);
    lv_style_set_bg_color(&style_scrCopy2_ddlistMode_extra_list_main_default, lv_color_hex(0x2f3243));
    ...
    lv_style_set_bg_color(&style_scrCopy2_ddlistMode_extra_list_scrollbar_default, lv_color_hex(0xc1c1c1));
    ...
    lv_obj_set_pos(ui->scrCopy2_ddlistDPI, 125, 8);
    lv_obj_set_size(ui->scrCopy2_ddlistDPI, 100, 35);
    lv_dropdown_set_options(ui->scrCopy2_ddlistDPI, "70 DPI\n96 DPI\n150 DPI\n300 DPI\n600 DPI\n900 DPI\n1200 DPI");
    ...
    lv_obj_set_style_text_font(ui->scrCopy2_ddlistDPI, &lv_font_montserratMedium_14, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_style_set_text_color(&style_scrCopy2_ddlistDPI_extra_list_main_default, lv_color_hex(0xffffff));
    lv_style_set_text_font(&style_scrCopy2_ddlistDPI_extra_list_main_default, &lv_font_montserratMedium_14);
    ...
    lv_style_set_radius(&style_scrCopy2_ddlistDPI_extra_list_main_default, 4);
    lv_style_set_bg_opa(&style_scrCopy2_ddlistDPI_extra_list_main_default, 255);
    lv_style_set_bg_color(&style_scrCopy2_ddlistDPI_extra_list_main_default, lv_color_hex(0x2f3243));
    ...
    lv_style_set_bg_color(&style_scrCopy2_ddlistDPI_extra_list_scrollbar_default, lv_color_hex(0xc1c1c1));
